...
public class UIManagePanel extends UIJPanelBG {
	...
	public UIManagePanel() {
		...
		// RadioButton for selecting ships
		...
		// Play Button
		ImageIcon playImg = new ImageIcon(getClass().getResource("/res/images/gioca.png"));
		ImageIcon playImgOver = new ImageIcon(getClass().getResource("/res/images/giocaOver.png"));
